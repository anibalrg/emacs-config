(deftheme zenit-dark
  "Atom dark + zenit. Created 2015-03-17.")
...
(custom-theme-set-faces
 ...
 '(highlight ((t (:background "#323a42444"))))
 ...
 '(mode-line ((t (:background "black" :foreground "#96CBFE" :scale 0.85))))
